...
type Props = {
    ...
    onFeedbackSent:(boolean:boolean) => void;
}

export const FeedbackContentStep = ({ FeedbackType , onFeedbackRestartRequested , onFeedbackSent }:Props) => {
    ...
    const handleFeedbackSubmit = async (e:React.FormEvent<HTMLElement>) => {
        e.preventDefault();
